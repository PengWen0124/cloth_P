...
<head>
    ...
    <title>My own clothes 新增訂單</title>
                        ...
                        <tr>
                            ...
                            <td>
                                <select class="col-2 form-control border border-dark" name="product" id="productSelect" onchange="updatePrice()">
                                    <option value="高山烏龍(精裝)|1899">高山烏龍(精裝) - $1899</option>
                                    <option value="高山紅茶(精裝)|1499">高山紅茶(精裝) - $1499</option>
                                    <option value="金萱(精裝)|1699">金萱(精裝) - $1699</option>
                                    <option value="日式櫻花紋(茶壺)|1599">日式櫻花紋(茶壺) - $1599</option>
                                </select>
                            </td>
                        </tr>
                        <tr>
